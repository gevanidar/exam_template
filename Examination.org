...
- [X] Förflyttningar i alla 4 riktningar. (Med tangenterna WASD.)
...
- [X] Bördig jord - efter varje 25:e drag skapas en ny frukt/grönsak någonstans på kartan.
...
- [X] Tryck "B" för att placera en bomb. Efter 3 drag smäller bomben och förstör allt på sin ruta och de åtta som gränsar till den. (fällor, väggar, m.m.) Om spelaren är kvar förlorar man poäng.
- [X] Ett nytt kommando ("T" för trap) för att desarmera fällor.
- [x] Använd TDD för att testa några av funktionerna i koden.
